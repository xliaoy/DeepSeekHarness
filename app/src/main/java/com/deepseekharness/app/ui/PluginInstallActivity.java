...
public final class PluginInstallActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle saved) {
        ...
        if (!HarnessController.get(this).isEnvironmentReady()) {
            status.setText(com.deepseekharness.app.util.UiText.text("请先完成 DeepSeekHarness 首次初始化，完成后会返回插件安装确认页")); install.setText(com.deepseekharness.app.util.UiText.text("初始化 DeepSeekHarness"));
    ...
    private void renderPreview() {
        ...
        if (preview != null) {
            ...
            install.setText(HarnessController.get(this).isEnvironmentReady() ? com.deepseekharness.app.util.UiText.text("解析链接 / 重试") : com.deepseekharness.app.util.UiText.text("初始化 DeepSeekHarness"));
        }
    }
