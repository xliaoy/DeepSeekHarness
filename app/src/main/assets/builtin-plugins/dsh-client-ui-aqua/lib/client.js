window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#region DeepSeekHarness 0.1.5 适配：compat 模式设置弹窗内部统一毛玻璃（不触碰 mica）
		const css$dh = '[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]{--dsw-alias-bg-layer-1:rgba(255,255,255,.38);--dsw-alias-bg-layer-2:rgba(255,255,255,.44);--dsw-alias-bg-layer-3:rgba(236,242,250,.4);--dsw-alias-bg-overlay:rgba(224,234,246,.46);--dsw-alias-bg-multi-select:rgba(255,255,255,.42);--dsw-specific-menu:rgba(255,255,255,.42);--dsw-specific-selector:rgba(236,242,250,.44);--dsw-specific-input-major:rgba(255,255,255,.44);--dsw-hovercard-bg:rgba(255,255,255,.5);--dsw-alias-markdown-code-block:rgba(240,245,251,.42)}[data-dsh-aqua][data-dsh-compat] body[data-ds-dark-theme] [aria-modal="true"]{--dsw-alias-bg-layer-1:rgba(17,26,39,.46);--dsw-alias-bg-layer-2:rgba(22,33,48,.52);--dsw-alias-bg-layer-3:rgba(28,42,61,.46);--dsw-alias-bg-overlay:rgba(34,51,74,.52);--dsw-alias-bg-multi-select:rgba(22,33,48,.52);--dsw-specific-menu:rgba(22,33,48,.52);--dsw-specific-selector:rgba(28,42,61,.5);--dsw-specific-input-major:rgba(16,25,39,.52);--dsw-hovercard-bg:rgba(22,33,48,.56);--dsw-alias-markdown-code-block:rgba(13,20,31,.46)}[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]>[class*="_nav"],[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]>[class*="_content"],[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]>[class*="_body"],[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]>[class*="_panel"]{backdrop-filter:blur(30px);-webkit-backdrop-filter:blur(30px)}[data-dsh-aqua][data-dsh-compat] [aria-modal="true"]>[class*="_nav"]{border-right:1px solid rgba(19,45,83,.12)}[data-dsh-aqua][data-dsh-compat] body[data-ds-dark-theme] [aria-modal="true"]>[class*="_nav"]{border-right-color:rgba(148,180,220,.14)}[data-dsh-aqua] [aria-modal="true"]>[class*="_content"],[data-dsh-aqua] [aria-modal="true"]>[class*="_body"],[data-dsh-aqua] [data-dsh-trajectory] [class*="_content"],[data-dsh-aqua] [data-dsh-trajectory] [class*="_details"],[data-dsh-aqua] [data-dsh-trajectory] [class*="_detail"]{background:color-mix(in srgb,rgb(255 255 255) 80%,transparent)}[data-dsh-aqua] body[data-ds-dark-theme] [aria-modal="true"]>[class*="_content"],[data-dsh-aqua] body[data-ds-dark-theme] [aria-modal="true"]>[class*="_body"],[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-trajectory] [class*="_content"],[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-trajectory] [class*="_details"],[data-dsh-aqua] body[data-ds-dark-theme] [data-dsh-trajectory] [class*="_detail"]{background:color-mix(in srgb,rgb(17 26 39) 82%,transparent)}';
		const tagId$dh = "dsh-client-ui-aqua/dsh-settings-glass";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$dh) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-client-ui-aqua";
			tag.dataset.pluginCss = tagId$dh;
			tag.textContent = css$dh;
			document.head.appendChild(tag);
		}
		//#endregion
		//#region DeepSeekHarness 移动端：云母(mica)模式窄屏适配
		const css$m = '@media (max-width:640px){/* DeepSeekHarness：云母侧边栏固定宽度（约 62vw，上限 400px）—— 不再由内容 max-content决定宽度，余额行等不会把侧边栏撑满整屏；62vw 接近原“占一半”的观感 */[data-dsh-aqua][data-dsh-float] [class*="sidebarCol"]{width:min(62vw,400px)!important;max-width:min(62vw,400px)!important}[data-dsh-float] [class*="bubble"]{border-radius:12px}[data-dsh-float] [class*="card"],[data-dsh-float] [role="menu"],[data-dsh-float] [role="dialog"]{border-radius:12px}[data-dsh-float] [data-composer-card],[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]){border-radius:16px}[data-dsh-float] [data-dsh-trajectory]{margin:6px 8px 10px;width:calc(100% - 16px);border-radius:16px}[data-dsh-float] button[class*="button"],[data-dsh-float] [class*="iconButton"]{border-radius:8px}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]{margin-bottom:8px}[data-dsh-float] [data-composer-card]{backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}[data-dsh-float] [data-dsh-stats],[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]),[data-dsh-float] [data-dsh-inputbar]:not([class*="hero"]){width:auto!important;max-width:calc(100vw - 16px)!important;margin-left:auto!important;margin-right:auto!important}[data-dsh-aqua][data-dsh-float] [data-phase="active"] [data-conversation-scroll],[data-dsh-aqua][data-dsh-float] html,[data-dsh-aqua][data-dsh-float] body{overflow-x:hidden!important}/* 关闭态：margin/边框/内边距归零（aqua 的折叠轨道 margin 会让 translateX(-110%) 滑出不全），并去掉玻璃/阴影/背景、整列强隐；展开态保持完整云母样式 */[data-dsh-aqua][data-dsh-float] [data-dsh-frame][data-sidebar-collapsed] [class*="sidebarCol"]{margin:0!important;padding:0!important;border:0!important;border-radius:0!important;overflow:visible!important;transition:transform .28s ease-in-out!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important;box-shadow:none!important;background:transparent!important}/* 关闭态：直接完全隐藏（display:none，不渲染不占位），双选择器覆盖两种标记 */[data-mobile-nav="frame"][data-sidebar-collapsed]>:first-child,[data-dsh-frame][data-sidebar-collapsed] [class*="sidebarCol"],[data-mobile-nav="frame"][data-sidebar-collapsed] [class*="sidebarCol"]{display:none!important;visibility:hidden!important;pointer-events:none!important}/* 文件浏览/预览弹层：保持 dsh-web-mobile 原样（不透明底、无玻璃），避免 mica 玻璃命中造成遮挡/残留 */[data-aionui-explorer-col],[data-aionui-preview-col]{backdrop-filter:none!important;-webkit-backdrop-filter:none!important;margin:0!important;background:var(--aion-bg-base,#fff)!important}[data-aionui-explorer-col] *,[data-aionui-preview-col] *{backdrop-filter:none!important;-webkit-backdrop-filter:none!important}}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]){width:calc(100vw - 44px)!important;max-width:calc(100vw - 44px)!important;margin-left:28px!important;margin-right:0!important;box-sizing:border-box!important;padding-left:0!important;padding-right:0!important;border-left:0!important;border-right:0!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) .uV2eYG_dock{display:grid!important;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr)!important;align-items:start!important;justify-items:stretch!important;gap:8px!important;width:100%!important;box-sizing:border-box!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats]{display:contents!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats] > .bOPqQW_anchor:first-child{order:1!important;justify-self:start!important;white-space:normal!important;display:flex!important;flex-wrap:wrap!important;align-items:center!important;min-width:0!important;max-width:100%!important;overflow-wrap:anywhere!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats] > .bOPqQW_anchor:last-child{order:3!important;justify-self:end!important;white-space:normal!important;display:flex!important;flex-wrap:wrap!important;align-items:center!important;min-width:0!important;max-width:100%!important;overflow-wrap:anywhere!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) [data-dsh-stats] .bOPqQW_pill{white-space:normal!important;overflow-wrap:anywhere!important;max-width:100%!important}[data-dsh-aqua][data-dsh-float] [data-dsh-inputbar]:has([data-dsh-stats]) .uV2eYG_dock > .JObwrW_root{order:2!important;justify-self:center!important;min-width:0!important;overflow-wrap:anywhere!important}';
		const tagId$m = "dsh-client-ui-aqua/dsh-mobile-mica";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$m) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-client-ui-aqua";
			tag.dataset.pluginCss = tagId$m;
			tag.textContent = css$m;
			document.head.appendChild(tag);
		}
		//#endregion
		...
		*/
		...
		/**
		* Aqua settings section (DeepSeekHarness 0.1.7 适配)：独立设置页——
		* 标题 + 描述 + 全部玻璃调节控件，注册到 settings.section（设置弹窗侧边栏
		* 单独出现「玻璃主题」页），替代 0.1.5 时代的 settings.general.item 内嵌行。
		*/
		function AquaSection(props) {
			const { t } = props;
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)(AquaAppearanceRow, props)
				]
			});
		}
		//#endregion
		...
		var AquaLayer = class {
			...
			*  glass panels stay frosted above the video. */
			...
			applyTokens() {
				...
				// DeepSeekHarness 适配：同步 theme-color meta，让 App 状态栏跟随 aqua 背景
				this.syncThemeBar();
			}
			mount() {
			...
			unmount() {
				...
				// DeepSeekHarness 适配：禁用后恢复状态栏主题色
				this.syncThemeBar();
			}
			/** DeepSeekHarness 适配：把当前 body 背景同步进 theme-color meta，App 状态栏即可跟随。 */
			syncThemeBar() {
				try {
					const color = getComputedStyle(document.body).backgroundColor;
					if (color && color !== "rgba(0, 0, 0, 0)" && color !== "transparent") {
						const meta = document.querySelector('meta[name="theme-color"]');
						if (meta !== null && meta.content !== color) meta.content = color;
						// DeepSeekHarness 状态栏专用上报：把 aqua 背景色直接发给 App 渲染状态栏。
						// 仅 App 内生效（App 的 WebChromeClient 监听此通道）；浏览器/其他环境中 console.log 无副作用。
						console.log("[DeepSeekHarness_THEME] " + color);
					}
				} catch (e) { /* ignore */ }
			}
